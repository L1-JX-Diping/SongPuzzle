...
//    public class Line
//    {
//        public float timing; // time in second
//        public string text; // Lyric content
...
//        public string word; // a part of lyric
//        public Color color; // 
...
//        // 次の歌詞行に進むべきタイミングか確認
//        if (_currentLyricIndex < maxIndex && currentTime >= nextLine.timing - LoadingTime)
//        {
//            _currentLyricIndex++;
//            UpdateLyricsDisplay();
//        }
...
//        else
//        {
//            Debug.LogWarning($"Duplicate color entry found: {Common.ToColorName(color)}, ignoring the second entry.");
//        }
//    }
...
//    {
//        // intro 前奏終了時刻 = 歌詞表示(のスクロール用時刻計算)開始時刻
//        float lineStartTime = 0f;

//        // 前奏 intro 部分用
//        LyricsList.Add(new Line { timing = 0.0f, text = "" });
...
//            // 歌詞スクロール計算の開始時刻
//            lineStartTime = introEndBeat * Clock; // lyricsStartTime
...
//            List<Part> partList = SetPartInfoListForThisLine(ratioList, barCount, lyrics, lineStartTime);

//            // lyricsList に追加
//            LyricsList.Add(new Line
//            {
//                timing = lineStartTime,
//                text = lyrics,
//                partList = partList
//            });

//            // 次の行の開始時刻計算
//            lineStartTime += _beat * barCount * Clock; // 6拍 (3拍子 * 2小節) * 0.5秒/拍 = 3秒
//        }
...
//        LyricsList.Add(new Line
//        {
//            timing = lineStartTime + 2f,
//            text = ""
//        });

//    }

//    private List<Part> SetPartInfoListForThisLine(List<int> ratioList, int barCount, string lyrics, float lineStartTime)
//    {
//        // パート色割り当て用
//        List<int> randomNumList = CreateRandomNumList(3);
//        int indexForPlayer = 0;
...
//            Color color = _colorList[randomNumList[indexForPlayer]];
